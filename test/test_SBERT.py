...
from emb_diversity.embeddings.SBERT import encode_sentences, encode_style_sentences, _get_model, encode_semantic_sentences
...
class TestSentenceEncoder:
    ...
    def test_encode_sentences_empty_input(self, mock_sentence_transformer):
        ...
        with patch('emb_diversity.embeddings.SBERT.SentenceTransformer', return_value=mock_sentence_transformer):
    ...
    def test_encode_sentences_custom_model(self, mock_sentence_transformer):
        ...
        with patch('emb_diversity.embeddings.SBERT.SentenceTransformer', return_value=mock_sentence_transformer) as mock_constructor:
